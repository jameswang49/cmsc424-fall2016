...
def instructorassignment(request, instructor_id, course_id, assignment_id):
	...
	context = { 'instructor_id': instructor_id, 'course_id': course_id, 'assignment_id': assignment_id, 'sa_list': sa_list, 'course': course, 'assignment': assignment, 'today': today }
...
def instructorgradesubmission(request, instructor_id, course_id, assignment_id, student_id):
	...
	sa_list = student_obj.assignment_set.filter(assignment__id = assignment_id).studentassignment_set.all()
